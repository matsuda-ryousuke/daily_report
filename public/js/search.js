$(function(){
  ...
  function get_area(){
      ...
      params[0] = '/get_area/' + $("#area_group").val();
      params[1] = 'GET';
      params[2] = '';
  ...
  function get_client_by_area_group(){
    var params = [6];
    // params[0] = '/get_user/dep/' + $("#bumon").val();
    params[0] = '/get_client_by_area_group/' + $("#area_group").val();
    params[1] = 'GET';
    params[2] = '';
    params[3] = function(data){
    ...
    /**
      ...
      function set_area_group_by_area(){
        var params = [6];
        params[0] = '/set_area_group_by_area/' + $("#area").val();
        params[1] = 'GET';
        params[2] = '';
        params[3] = function(data){
            $('#area_group')
      ...
      function set_area_group(){
        var params = [6];
        params[0] = '/set_area_group/' + $("#client").val();
        params[1] = 'GET';
        params[2] = '';
        params[3] = function(data){
            $('#area_group')
